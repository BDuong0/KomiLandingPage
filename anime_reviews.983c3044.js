...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"anime_reviews.js":[function(require,module,exports) {
var define;
...
function getReviewData() {
  return _getReviewData.apply(this, arguments);
}
function _getReviewData() {
  _getReviewData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response, json_object;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return fetch('https://api.jikan.moe/v4/anime/48926/reviews');
        case 3:
          response = _context.sent;
          _context.next = 6;
          return response.json();
        case 6:
          json_object = _context.sent;
          // Going to try to use '...' spread operator which essentially spreads the items of an array into separate items
          anime_reviews.push.apply(anime_reviews, _toConsumableArray(json_object.data));
...
var reviews_wrapper = document.querySelector('.review_wrapper');
function processReviewData() {
  return _processReviewData.apply(this, arguments);
}
function _processReviewData() {
  _processReviewData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          anime_reviews.forEach(function (malUser) {
            var output_username = malUser.user.username;
            var processed_review = malUser.review.replace(/\n/g, "<br>");
...
function populateHTMLpage() {
  var all_reviews = document.querySelectorAll('.review_wrapper .review');
  all_reviews.forEach(function (review) {
    var review_header = review.querySelector('.review__header');
    var review_content = review.querySelector('.review__content');
    var review__collapse_btn = review.querySelector('.review__collapse-btn');
    var review__collapse_text = review__collapse_btn.querySelector('.collapse__text');
    var content_pText = review_content.firstElementChild;
    ...
    var content_font_size = Number(window.getComputedStyle(content_pText).getPropertyValue("font-size").replace(/px$/, '')); // Get the font-size without the 'px'
    var min_content = content_font_size * 13; // mimic 13ch which I want as the minimum height of content shown
    var entire_content_height = content_pText.scrollHeight; // Kind of like scrollHeight but without the scrolling. Get the height of the content, including content that overflows.

    if (entire_content_height > min_content) {
      // Only enable collapsible on reviews that have more than 13ch of content
      ...
      review__collapse_btn.addEventListener('click', function (e) {
        ...
        var btn_state = review__collapse_btn.dataset.btnState;
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","anime_reviews.js"], null)
//# sourceMappingURL=/anime_reviews.983c3044.js.map